...
var regions_js_1 = require("../../data/regions.js");
var departments_js_1 = require("../../data/departments.js");
var RegionsService;
(function (RegionsService) {
    ...
    function getRegionByName(name) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getRegions()];
                    case 1:
                        regions = _a.sent();
                        region = regions
    ...
    function getDepartmentsByRegionName(name) {
        return __awaiter(this, void 0, void 0, function () {
            var region, departmentsByRegion;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getRegionByName(name)];
                    case 1:
                        region = _a.sent();
                        if (region) {
                            departmentsByRegion = departments_js_1.departments
                                .filter(function (department) {
                                return department.name.toLowerCase() === region.name.toLowerCase() ||
                                    department.region_code === region.code;
                            });
                            if (departmentsByRegion) {
                                return [2 /*return*/, departmentsByRegion];
                            }
                        }
                        return [2 /*return*/];
                }
