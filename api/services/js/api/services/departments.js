...
(function (DepartmentsService) {
    function getDepartments() {
        return Promise.resolve(departments_js_1.departments);
    }
    ...
    function getDepartmentByName(name) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getDepartments()];
                    case 1:
                        departments = _a.sent();
                        department = departments.find(function (department) { return department.name.toLowerCase() === name.toLowerCase(); });
                        if (department) {
