...
const departments_js_1 = require("../services/departments.js");
const router = (0, express_1.Router)();
// Route pour récupérer tous les départements
router.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const departments = yield departments_js_1.DepartmentsService.getDepartments();
...
router.get("/:name", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const department = yield departments_js_1.DepartmentsService.getDepartmentByName(name);
    if (department) {
